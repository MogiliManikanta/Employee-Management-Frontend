    ...
    const fetchEmployee = async () => {
      try {
        const response = await axios.get(
          `https://employee-management-backend-uhoe.onrender.com/api/employee/${id}`,
          {
            headers: {
        ...
        <div className="max-w-4xl mx-auto mt-10 bg-white p-8 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex justify-center items-center">
              <img
                src={`https://employee-management-backend-uhoe.onrender.com/${employee.userId.profileImage}`}
                alt="Employee"
